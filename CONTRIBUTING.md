...
issue](https://github.com/cisagov/dmarc-import-tf-module/issues) in
...
request](https://github.com/cisagov/dmarc-import-tf-module/pulls), you
...
```console
cd dmarc-import-tf-module
pyenv virtualenv <python_version_to_use> dmarc-import-tf-module
pyenv local dmarc-import-tf-module
